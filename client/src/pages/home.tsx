...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="modern-hero-gradient min-h-[70vh] flex items-center justify-center text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10 max-w-6xl">
          ...
          >
            ...
            <div className="mb-8 pt-16 pb-4">
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-normal font-alex-brush leading-[1.3] tracking-tight">
      ...
      {/* About Section */}
      <section id="about" className="py-24 bg-gradient-to-b from-blue-50/40 via-cyan-50/30 to-blue-50/40 relative overflow-hidden section-modern">
      ...
      {/* Portfolio Section */}
      <section id="portfolio" className="py-24 bg-gradient-to-b from-teal-50/30 via-blue-50/20 to-teal-50/30 relative overflow-hidden section-modern">
        <div className="container mx-auto px-6 relative z-10">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
